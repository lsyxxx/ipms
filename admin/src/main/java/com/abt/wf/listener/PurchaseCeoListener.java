...
@Component
@Slf4j
public class PurchaseCeoListener implements TaskListener {

    private final PurchaseService purchaseService;
    private final RuntimeService runtimeService;

    public PurchaseCeoListener(PurchaseService purchaseService, RuntimeService runtimeService) {
    ...
    public void notify(DelegateTask delegateTask) {
        ...
        purchaseService.setCeoUser(delegateTask.getAssignee(), main);
