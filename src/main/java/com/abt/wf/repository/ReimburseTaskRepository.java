...
public interface ReimburseTaskRepository {
    List<Reimburse> findDoneList(int page, int limit, String userid, String username, String startDate, String endDate, String state,
    ...
    List<Reimburse> findTodoList(int page, int limit, String userid, String username, String startDate, String endDate, String state, String idLike, String contractName);

    int countTodoList(String userid, String username, String startDate, String endDate, String state, String idLike, String projectName);

    List<Reimburse> findUserApplyList(int page, int limit, String userid, String username, String startDate, String endDate, String state,
