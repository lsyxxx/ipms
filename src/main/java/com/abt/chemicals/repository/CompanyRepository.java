...
public interface CompanyRepository extends JpaRepository<Company, String> {
    ...
    List<Company> findByTypeAndNameContainingOrderBySortAsc(@Param("type_") String type, @Param("name_") String name, Pageable page);

    List<Company> findAllByEnableIsTrueOrderByTypeAsc(Sort sort);
}
